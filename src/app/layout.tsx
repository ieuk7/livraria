    ...
    <html lang="en">
      ...
      <body className="font-body antialiased">
        ...
        <aside id="lovable-badge" role="complementary" dir="ltr" lang="en" aria-label="Edit with Lovable">
          <a id="lovable-badge-cta" target="_blank" href="https://lovable.dev" rel="noopener nofollow" aria-label="Edit with Lovable">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="52" height="16" fill="none" viewBox="0 0 52 16">
              ...
              <path fill="url(#a)" fillRule="evenodd" d="M2.7 3c1.492 0 2.7 1.192 2.7 2.663v1.012h.9c1.49 0 2.7 1.192 2.7 2.662S7.791 12 6.3 12H0V5.663C0 4.193 1.209 3 2.7 3Z" clipRule="evenodd"></path>
              <defs>
                <radialGradient id="a" cx="0" cy="0" r="1" gradientTransform="matrix(-1.54236 7.07838 -10.231 -2.15602 4.627 5.022)" gradientUnits="userSpaceOnUse">
                  <stop offset=".106" stopColor="#FE7B02"></stop>
                  <stop offset=".394" stopColor="#FE3F21"></stop>
                  <stop offset=".608" stopColor="#F858BC"></stop>
                  <stop offset=".929" stopColor="#575ECF"></stop>
                </radialGradient>
              </defs>
            </svg>
          </a>
