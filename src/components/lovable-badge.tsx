...
export function LovableBadge() {
  ...
  useEffect(() => {
    ...
    const isNotPuppeteer = !navigator.userAgent.includes('puppeteer');
    
    if (isNotInIframe && isNotPuppeteer) {
      setIsVisible(true);
    }
  }, []);
  ...
  return (
    <aside id="lovable-badge" role="complementary" dir="ltr" lang="en" aria-label="Edit with Lovable">
      ...
      <button id="lovable-badge-close" aria-label="Dismiss" title="Dismiss" type="button" onClick={handleClose}>
